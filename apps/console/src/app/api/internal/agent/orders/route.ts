...
export async function POST(request: Request) {
  ...
  try {
    ...
    await audit(null, { action: result.idempotent ? "ORDER_IDEMPOTENT_RETURN" : "ORDER_CREATE", resourceType: "demo_order", resourceId: result.order.orderNo, detail: { sessionId: parsed.data.sessionId } });
